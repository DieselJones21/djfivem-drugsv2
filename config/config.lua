...
local function scatter(x, y, z, count, radius)
    local positions = {}
    for i = 1, count do
        local angle = (i / count) * math.pi * 2 + (i * 0.19)
        local dist = radius * (0.38 + ((i * 13) % 50) / 100.0)
...
Config.Harvest = {
    ...
    field({
        ...
        plant = true,
        coords = vec3(2436.50, 4974.20, 46.10),
        radius = 22.0,
        pool = 16,
        model = `prop_weed_01`,
        duration = 6500,
    ...
    field({
        ...
        plant = true,
        coords = vec3(-1854.20, 1912.40, 139.40),
        radius = 20.0,
        pool = 16,
        model = `prop_weed_01`,
        duration = 6500,
    ...
    field({
        ...
        plant = false,
        coords = vec3(2954.20, 2786.40, 40.20),
        radius = 20.0,
        pool = 16,
        model = `prop_rock_4_c`,
        duration = 7000,
    ...
    field({
        ...
        plant = false,
        coords = vec3(2003.10, 3779.40, 32.18),
        radius = 16.0,
        pool = 14,
    ...
    field({
        ...
        plant = false,
        coords = vec3(414.20, -767.40, 29.30),
        radius = 18.0,
        pool = 16,
        model = `prop_rock_4_c`,
        duration = 7000,
    ...
    field({
        ...
        plant = false,
        coords = vec3(892.10, -2172.00, 30.50),
        radius = 16.0,
        pool = 14,
        model = `prop_box_wood05a`,
        duration = 6000,
    ...
    field({
        ...
        plant = false,
        coords = vec3(850.40, -1990.20, 29.30),
        radius = 15.0,
        pool = 12,
        model = `prop_box_wood05a`,
        duration = 5500,
    ...
    field({
        ...
        plant = false,
        coords = vec3(2350.40, 3060.20, 48.20),
        radius = 20.0,
        pool = 16,
        model = `prop_rock_4_c`,
        duration = 6500,
    ...
    field({
        ...
        plant = false,
        coords = vec3(546.20, 2670.40, 42.20),
        radius = 14.0,
        pool = 12,
        model = `prop_box_wood05a`,
        duration = 5000,
