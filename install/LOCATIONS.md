...
This is the **Rebel** branch. Harvest fields and process benches are **not** the Envy farms — they were moved so both versions can run without sharing spots.
...
| Zip Bags | 1703.44, 3596.21, 35.47 | `prop_cs_cardbox_01` |
...
|---------|------------------|---------|------|
| Longhorn Kush | 1960.85, 5174.22, 47.94 | 140.00 | `bkr_prop_weed_table_01a` |
| Dirt Road Haze | -2194.40, 4290.10, 49.17 | 235.00 | `bkr_prop_weed_table_01a` |
| Chrome Snow | 968.20, -1828.40, 31.24 | 85.00 | `bkr_prop_coke_table01a` |
| Sandlot Ice | 1391.55, 3606.80, 38.94 | 200.00 | `bkr_prop_meth_table01a` |
| Outlaw Brick | 154.40, -3078.20, 5.98 | 270.00 | `prop_tool_bench02` |
| Honkytonk Rolls | 372.80, -1267.40, 32.51 | 50.00 | `prop_tool_bench02` |
| Swamp Lean | 113.20, -1966.80, 21.33 | 15.00 | `prop_tool_bench02` |
| Truck Juice | 2748.10, 1454.60, 24.50 | 75.00 | `bkr_prop_meth_table01a` |
| Gravel Dust | 1980.40, 3049.70, 47.22 | 145.00 | `prop_tool_bench02` |
| Cayo Crown | 4904.80, -5743.20, 26.35 | 330.00 | `prop_tool_bench02` |
